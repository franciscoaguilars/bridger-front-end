  ...
  return (
    <div>
      ...
      <div className="about-banner-overlay">
        <div className="about-banner-overlay-header">Tutoring For A Fair Future</div>
      </div>
      </div>
        ...
        <div className="mb-5">
          <div className="row mb-4">
            <div className="col-lg-4 col-sm-12 d-flex align-items-center d-flex align-items-center">
              <h1 className="mb-4">What Is Smart Reach?</h1>
            </div>
